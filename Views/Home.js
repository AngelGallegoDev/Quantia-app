      ...
      <View className="flex-row mt-10">
        <View className="w-1/2 h-16">
          <View className="flex-1 items-center justify-center">
            <Text className="text-sm font-bold">Montly Earnings</Text>
            <Text className="text-2xl font-bold text-center mt-4 text-green-800">
              $100.000
            </Text>
          </View>
        </View>
        <View className="w-1/2 h-16">
          <View className="flex-1 items-center justify-center">
            <Text className="text-sm font-bold">Montly Expenses</Text>
            <Text className="text-2xl font-bold text-center mt-4 text-green-800">
              $100.000
            </Text>
          </View>
